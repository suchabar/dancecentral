    ...
    <div class="row">
        <div class="col-sm-12">
            <?php echo validation_errors('<div class="alert alert-warning alert-dismissible" role="alert">
                ...
                <strong>Error!</strong>
                <?php echo isset($displayError)? $displayError : '' ?>
            </div>
            ...
            <?php echo isset($displaySuccess)? $displaySuccess: '' ?>
        </div>
        ...
        <fieldset>
            ...
            <div class="form-group">
                <label class="control-label col-sm-2" for="newAvatar">Avatar</label>
                <div class="col-sm-1">
                    <img id="avatar" class="img-responsive img-rounded" src="<?php echo base_url(). 'img/avatars/'. (($userData->hasAvatar == 0) ? $userData->avatar: 'user.jpeg') ?>"
        ...
        <fieldset>
            ...
            <div id="emailField" class="form-group required ">
                ...
                <!--PASSWORD-->
                <div class="form-group">
                    <h5 class="control-label col-sm-2" ><b>Password</b></h5>
                    <div class="col-sm-3">
