...
<div class="row">
    ...
    <div class="col-md-6">
        <audio id="dnb1" src="<?php echo base_url(); ?>music/dnb/1.mp3"></audio>
        <audio id="dnb2" src="<?php echo base_url(); ?>music/dnb/2.mp3"></audio>
        <audio id="dnb3" src="<?php echo base_url(); ?>music/dnb/3.mp3"></audio>
        <audio id="dnb4" src="<?php echo base_url(); ?>music/dnb/4.mp3"></audio>
        <audio id="dnb5" src="<?php echo base_url(); ?>music/dnb/5.mp3"></audio>
        <audio id="dnb6" src="<?php echo base_url(); ?>music/dnb/6.mp3"></audio>
        <audio id="dnb7" src="<?php echo base_url(); ?>music/dnb/7.mp3"></audio>
        <audio id="dnb8" src="<?php echo base_url(); ?>music/dnb/8.mp3"></audio>
        <h3>DnB - LIQUID</h3>
